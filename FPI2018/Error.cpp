...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] = 
	{
		...
		ERROR_ENTRY(100, "Параметр -in и -d должен быть задан"), 
		...
		ERROR_ENTRY(501, "Ошибка в семантическом анализаторе"),
		ERROR_ENTRY(502, "Не соответствуют типы при сравнение"),
		ERROR_ENTRY(503, "Не возращает нужный тип или функция типа строки"),
		...
		ERROR_ENTRY(505, "Не соответствуют типы в параметрах функции или перебор параметров\
						 \n или в параметрах в функции нестандартной библиотека строка"),
		...
		ERROR_ENTRY(600, "Ошибка в объявление функции"),
		ERROR_ENTRY(601, "Ошибка в конструкции языка или в операторе"),
		ERROR_ENTRY(602, "Ошибка в выражение"),
		ERROR_ENTRY(603, "Ошибка в выражение"),
		ERROR_ENTRY(604, "Неверно указана операция сравнения"),
		ERROR_ENTRY(605, "Ошибка в параметрах объявляемой функции"),
		ERROR_ENTRY(606, "Ошибка в параметрах вызываемой функции"),
		ERROR_ENTRY(607, "Ошибка в цикле for"),
