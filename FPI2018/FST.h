...
#define FST_STRLIT 2,	\
	...
	\
	FST::RELATION('à', 0), FST::RELATION('á', 0), FST::RELATION('â', 0), FST::RELATION('ã', 0), FST::RELATION('ä', 0), FST::RELATION('å', 0),\
	FST::RELATION('¸', 0), FST::RELATION('æ', 0), FST::RELATION('ç', 0), FST::RELATION('è', 0), FST::RELATION('é', 0), FST::RELATION('ê', 0),\
	FST::RELATION('ë', 0), FST::RELATION('ì', 0), FST::RELATION('í', 0), FST::RELATION('î', 0), FST::RELATION('ï', 0), FST::RELATION('ð', 0),\
	FST::RELATION('ñ', 0), FST::RELATION('ò', 0), FST::RELATION('ó', 0), FST::RELATION('ô', 0), FST::RELATION('õ', 0), FST::RELATION('ö', 0),\
	FST::RELATION('÷', 0), FST::RELATION('ø', 0), FST::RELATION('ù', 0), FST::RELATION('ú', 0), FST::RELATION('û', 0), FST::RELATION('ü', 0),\
	FST::RELATION('ý', 0), FST::RELATION('þ', 0), FST::RELATION('ÿ', 0), FST::RELATION(' ', 0), FST::RELATION('.', 0), FST::RELATION(',', 0),\
